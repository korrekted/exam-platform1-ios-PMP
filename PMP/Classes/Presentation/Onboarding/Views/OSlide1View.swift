...
private extension OSlide1View {
    func makeConstraints() {
        NSLayoutConstraint.activate([
            ...
            imageView.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 90.scale : 60.scale),
            imageView.widthAnchor.constraint(equalToConstant: 253.scale),
            imageView.heightAnchor.constraint(equalToConstant: ScreenSize.isIphoneXFamily ? 288.scale : 240.scale)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            text1Label.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: 64.scale)
        ])
